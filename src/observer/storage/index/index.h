...
public:
  ...
  virtual RC create(Table *table, const char *file_name, const IndexMeta &index_meta, const std::vector<FieldMeta> &field_metas)
  {
    return RC::UNSUPPORTED;
  }
  virtual RC open(Table *table, const char *file_name, const IndexMeta &index_meta, const std::vector<FieldMeta> &field_metas)
  {
    return RC::UNSUPPORTED;
  }
...
protected:
  ...
  std::vector<FieldMeta> field_metas_;          ///< 支持多个字段的索引
};
